...
try {
    ...
    $mail->Username = 'clinzthankach@gmail.com';                 // SMTP username
    $mail->Password = 'vergqwlfsjfjegry';                           // SMTP password
...
'allow_self_signed' => true
   ...
   $mail1->isSMTP();                                      // Set mailer to use SMTP
    ...
    $mail1->Username = 'clinzthankach@gmail.com';                 // SMTP username
    $mail1->Password = 'vergqwlfsjfjegry';                           // SMTP password
...
'allow_self_signed' => true
    ...
    $mail->setFrom('clinzthankach@gmail.com', 'Infi data');
    ...
    $mail1->addAddress('clinzthankach@gmail.com');     // Add a recipient
